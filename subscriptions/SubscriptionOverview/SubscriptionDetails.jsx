  ...
  return (
    <section className="w-full h-full px-4 py-4">
      ...
      <div className="flex flex-col lg:flex-row justify-between w-full">
        ...
        <div className="gap-2.5 self-stretch px-3.5 py-3 my-auto text-sm font-medium leading-none text-violet-600 bg-primaryalpha/20 rounded-md border border-violet-300 border-dashed">
          Client ID: 35846895
        </div>
      </div>
